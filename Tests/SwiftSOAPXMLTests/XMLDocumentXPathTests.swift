...
final class XMLDocumentXPathTests: XCTestCase {
    ...
    func test_serializedData_roundTrips() throws {
        ...
        let roundTripped = try SwiftSOAPXML.XMLDocument(data: serialized)
    ...
    func test_builder_createsEnvelopeWithNamespacesAndBodyText() throws {
        ...
        let document = try SwiftSOAPXML.XMLDocument(rootElementName: "Envelope", rootNamespace: soapNamespace)
        ...
        let parsedDocument = try SwiftSOAPXML.XMLDocument(data: serializedData)
